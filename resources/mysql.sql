...
CREATE TABLE IF NOT EXISTS players(
    ...
    lastCommandUse  DATETIME                    DEFAULT NULL,
...
ON DUPLICATE KEY UPDATE playerName = VALUES(playerName), skinData = VALUES(skinData);
-- #    }
-- #    { showSkulls
-- #      :playerUUID string
-- #      :showSkulls bool
...
-- #      :playerUUID string
-- #      :skinData string
REPLACE INTO skulls(worldName, x, y, z, playerUUID, skinData)
